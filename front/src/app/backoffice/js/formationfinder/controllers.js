...
app.controller("indexController", ["$scope", "$rootScope", "$location", "$http", "NgMap", "$log",
    ...
    .controller("LoginController", ["$scope", "$rootScope", "$location", "$http", "NgMap", "$log",
        function ($scope, $rootScope, $location, $http, NgMap, $log) {
                ...
                $http.post($rootScope.urlBase + "/login/check", {
                    ...
                    .success(function (data) {
                        if (data.status === "ok") {
                            ...
                            $rootScope.formationCenter = $scope.credentials.formationCenter;
    ...
    .controller("DeleteLogincontroller", ["$scope", "$rootScope", "$location", "$http",
        function ($scope, $rootScope, $location, $http) {
            ...
            $scope.searchLoginNames = function () {
                $http.post($rootScope.urlBase + "/login/searchAllUserNames", {
...
// Disable weekend selection
    ...
    .controller("PlaceEditcontroller", ["$scope", "$rootScope", "$http", "$location", "$routeParams", "$timeout", "NavigatorGeolocation", "NgMap",
        function ($scope, $rootScope, $http, $location, $routeParams, $timeout, NavigatorGeolocation, NgMap) {


        }])
    .controller("PlaceListcontroller", ["$scope", "$rootScope", "$http", "$location", "$routeParams", "$timeout", "NavigatorGeolocation", "NgMap",
        function ($scope, $rootScope, $http, $location, $routeParams, $timeout, NavigatorGeolocation, NgMap) {

            $scope.searchAllPlaces = function () {
                $http.get($rootScope.urlBase + "/Place/searchallplaces")
                    .success(function (data) {
